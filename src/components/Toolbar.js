    ...
    return (
        <>
            <div class='toolbar' >
                ...
                <a href='https://drive.google.com/file/d/1VRBQ7SOTRMZCstxbJ4CI7cqSpMnLlWRa/view?usp=sharing' class='toolbar-text' target="_blank" rel="noopener noreferrer">Resume</a>
            </div>
        </>
    )
}
